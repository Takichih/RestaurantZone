      ...
      <v-expansion-panel v-for="list in favoriteLists" :key="list.id">
        <v-expansion-panel-title>
          <div class="d-flex align-center justify-space-between" style="width: 100%">
            ...
            <v-text-field v-else v-model="list.newName" label="Renommer la liste" dense :rules="[nameRequiredRule]"
              maxlength="50" required hide-details style="max-width: 200px"></v-text-field>
        ...
        <v-expansion-panel-text>
          <v-list>
            <v-list-item v-for="restaurant in list.restaurants" :key="restaurant.id">
